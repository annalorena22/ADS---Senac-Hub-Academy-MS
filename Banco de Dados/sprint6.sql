...
insert into revista values (null, 'Época', null);
insert into revista values (null, 'Istoé', null);
insert into revista values (null, 'Capricho', null);

update revista set categoria = 'Moda' where idRevista =1;
update revista set categoria = 'Ciênca' where idRevista =2;
update revista set categoria = 'Cultura' where idRevista = 3;
update revista set categoria = 'Adolescente' where idRevista = 4;

select * from revista;

insert into revista values (null, 'Recreio', 'Infantil');
insert into revista values (null, 'Vogue', 'Moda');
insert into revista values (null, 'Caras', 'Celebridade');
...
update revista set periodicidade = '15 dias' where idRevista =1;
update revista set periodicidade = '30 dias' where idRevista =2;
update revista set periodicidade = '30 dias' where idRevista = 3;
update revista set periodicidade = '15 dias' where idRevista = 4;
update revista set periodicidade = '15 dias' where idRevista =5;
update revista set periodicidade = '30 dias' where idRevista =6;
update revista set periodicidade = '30 dias' where idRevista = 7;
